...
public class HashMapDemo {
    ...
    public static void main(String[] args) {
        /*1. Map contains key value pair
        * 2. Each key value pair is known as entry
        * 3. Two interfaces for map - Map and SortedMap
        * 4. Three classes - HashMap , TreeMap and LinkedHashMap.
        * 5. Map does not allow duplicate keys , allows duplicate values */
        ...
        // 10. forEach(BiConsumer) - Iterating over HashMap
